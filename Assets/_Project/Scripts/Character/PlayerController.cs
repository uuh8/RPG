...
namespace Game.Character
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [Header("Jump")]
        [SerializeField] private float _gravityMultiplier = 2f;         // 跳跃上升阶段的重力加速度倍数
        ...
        [Header("Slope")]
        [SerializeField] private float _slideSpeed = 6f;    // 滑落速度

        [Header("Interaction")]
        [SerializeField] private float _pushForce = 3f;

        [Header("Camera")]
        [SerializeField] private Transform _cameraRoot;        // 相机枢轴，Inspector 里拖 CameraRoot
