...
// 与 IFluidGpuSource.cs 中的 FluidGpuSpawnRequest 保持 48-byte 顺序一致。
...
{
    return (flags & (FLUID_ALIVE_FLAG | FLUID_INTEREST_ACTIVE_FLAG | FLUID_REQUIRES_SIMULATION_FLAG))
